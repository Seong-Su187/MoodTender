...
class Avatar:
    ...
    def init(self):
        if self.preparation:
            ...
            if avatar_info['bbox_shift'] != self.avatar_info['bbox_shift']:
                # bbox_shift 변경 시 자동 재생성 (input() 없이)
                print(f"[Avatar] bbox_shift 변경 감지 ({avatar_info['bbox_shift']} → {self.avatar_info['bbox_shift']}), 재생성 중...")
                shutil.rmtree(self.avatar_path)
                print("*********************************")
                print(f"  creating avator: {self.avatar_id}")
                print("*********************************")
    ...
    def prepare_material(self):
        ...
        self.frame_list_cycle = frame_list + frame_list
        self.coord_list_cycle = coord_list + coord_list
        self.input_latent_list_cycle = input_latent_list + input_latent_list
